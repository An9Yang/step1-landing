...
export function Showcase() {
    ...
    return (
        <section id="showcase" className="min-h-screen flex flex-col justify-center bg-white snap-start py-16 md:py-20 relative">
            ...
            <Container>
                ...
                >
                    <div className="max-w-xl space-y-3">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-100 border border-neutral-200 w-fit">
                            <Sparkles className="w-4 h-4 text-neutral-500" />
                            <span className="text-xs font-mono tracking-wider uppercase text-neutral-600">Showcase</span>
                        </div>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900">Proof of fidelity — scroll the clone.</h2>
                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-end gap-2">
                            ...
                            {templates.map((t) => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        t.id === activeId ? "text-neutral-900" : "text-neutral-500 hover:text-neutral-900"
                                    )}
                                >
                                    {t.id === activeId && (
                                        <motion.span
                        ...
                        <Button
                            size="sm"
                            variant="ghost"
                            className="rounded-full gap-2 text-neutral-500 hover:text-neutral-900 hover:bg-neutral-100"
                ...
                <motion.div
                    ...
                    className="rounded-2xl border border-neutral-200 bg-white overflow-hidden shadow-xl"
                >
                    <div className="h-10 px-4 flex items-center justify-between border-b border-neutral-200 bg-neutral-50">
                        ...
                        <div className="text-xs text-neutral-400 hidden sm:block">Scroll inside</div>
                    </div>
                ...
                >
                    <div className="flex flex-wrap items-center gap-2 text-xs text-neutral-500">
                        <span className="inline-flex items-center rounded-full border border-neutral-200 bg-neutral-100 px-2.5 py-1">
                            Real render
                        </span>
                        <span className="inline-flex items-center rounded-full border border-neutral-200 bg-neutral-100 px-2.5 py-1">
                            Components + layout
